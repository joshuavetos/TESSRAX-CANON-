...
## Definition
Epistemic Recovery Time (ERT) is the time required for humans to
reconstruct the authoritative state of a system after total digital loss.
...
They do NOT measure:
- How long until a human knows what is true

This diagnostic exposes that gap.
...
| Criteria | 0 | 1 | 2 |
|--------|---|---|---|
| Tool Isolation | Cloud/LLM used | Local tools | Paper only |
...
## Red Flag
If leadership cannot tolerate this test,
the institution is committing semantic fraud.
